...
macro(ome_find_pkg var pkg version_var)
    ...
    elseif(_FP_FOUND_BUT_MISMATCH)
        ...
        if(OME_SKIP_DEPENDENCY_CHECK)
            message(STATUS "${_FP_FAIL_MESSAGE} (accepting installed version: OME_SKIP_DEPENDENCY_CHECK)")
            pkg_check_modules(${var} QUIET IMPORTED_TARGET ${_FP_PKG_NAME})
        elseif(_FP_ON_MISMATCH STREQUAL "FATAL")
